...
```{r fig-SVD, out.width='50%', fig.show='hold', fig.cap='Illustration der SVD. Bitte beachten, der $*$ bedeutet hier transponiert und komplex konjugiert. By Cmglee - Own work, CC BY-SA 4.0, https://commons.wikimedia.org/w/index.php?curid=67853297', eval=TRUE, echo=FALSE}
knitr::include_graphics('bilder/06_412px-Singular_value_decomposition_visualisation.svg.png')
```
