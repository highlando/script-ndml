...
\end{equation*}
Diese Abbildung ist linear und könnte als Matrix (bzw. Tensor im Sinne
...
\(\sigma'(A_2x_1)\in \mathbb R^{n_2\times n_2}\) und \(L_{[x_1]}\in \mathbb R^{n_2\times(n_2\times n_1)}\) ergibt\ldots{}
