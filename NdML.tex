...
\end{equation*}
wobei der innere Term die Erwartung ist unter der Bedingung das \(x_k\) eingetreten ist (folgt aus dem Satz der \emph{iterated expectation}).
...
\end{split}
\end{equation*}
sodass mit der strengen \(m\)-Konvexität gilt dass
\begin{equation*}
