...
\(\partial w_4=\cos(w_1)\)\strut
\end{minipage} & \begin{minipage}[t]{0.41\columnwidth}\raggedright
\(\bar w_4 = \bar w_5 \cdot 1 = 1\)\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.10\columnwidth}\raggedright
\texttt{2b}\strut
\end{minipage} & \begin{minipage}[t]{0.17\columnwidth}\raggedright
...
\(\partial w_3=\begin{bmatrix}w_2&w_1\end{bmatrix}\)\strut
\end{minipage} & \begin{minipage}[t]{0.41\columnwidth}\raggedright
\(\bar w_3 = \bar w_5 \cdot 1 = 1\)\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.10\columnwidth}\raggedright
\texttt{3b}\strut
\end{minipage} & \begin{minipage}[t]{0.17\columnwidth}\raggedright
...
\strut
\end{minipage} & \begin{minipage}[t]{0.41\columnwidth}\raggedright
\(\bar w_1 = \bar w_3 w_2 +\bar w_4 \cos(w_1) = x_2 + \cos(x_1)\)\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
...
\leavevmode\hypertarget{ad-applications}{}%
\begin{JHSAYS}
