...
\hypertarget{automatisches-differenzieren-algorithmisches-differenzieren}{%
\chapter{Automatisches Differenzieren (Algorithmisches Differenzieren)}\label{automatisches-differenzieren-algorithmisches-differenzieren}}

In der Mathematik und im Bereich der Computeralgebra ist das \textbf{automatische
Differenzieren} (auch \textbf{Auto-Differenzieren}, \textbf{Autodiff} oder einfach \textbf{AD}
genannt und in anderen communities als \textbf{algorithmisches Differenzieren} oder
\textbf{computergestütztes Differenzieren}), ein Satz von Techniken zur Bewertung der
...
\hypertarget{unterschied-zu-anderen-differentiationsmethoden}{%
\section{Unterschied zu anderen Differentiationsmethoden}\label{unterschied-zu-anderen-differentiationsmethoden}}
...
(die Methode der finiten Differenzen) ist enorm schlecht konditioniert (da im Nenner des Differenzenquotienten fast gleich grosse Größen subtrahiert werden).
Beide klassischen Methoden
haben Probleme mit der Berechnung höherer Ableitungen, wo Komplexität und Fehler
zunehmen. Diese Komplexität macht sich bei multivariablen Funktionen
bemerkbar, da die \(m \cdot n\) (Anzahl abhängiger mal mal Anzahl unabhängiger Variablen) einzeln berechnet werden.
